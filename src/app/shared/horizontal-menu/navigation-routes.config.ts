...
export const HROUTES: RouteInfo[] = [
  ...
  {
    path: '', title: 'Offre', icon: 'ft-bar-chart-2', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
    submenu: [
      { path: 'offres', title: 'list_offre', icon: 'ft-airplay' , class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
  ...
  {
    path: '', title: 'Users', icon: 'ft-users mr-1', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
    submenu: [
      //{ path: '/users-add', title: 'Add', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
      { path: '/users-list', title: 'List', icon: 'ft-user mr-1', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
  ...
  {
    path: '', title: 'Roles', icon: 'ft-briefcase', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
    submenu: [
      { path: '/roles-list', title: 'List', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }
      /* { path: '/roles-edit', title: 'Edit', icon: 'ft-arrow-right submenu-icon', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }*/
    ]
  },/*
